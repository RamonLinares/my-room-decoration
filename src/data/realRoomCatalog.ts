...
export const REAL_ROOM_CATALOG: RealRoomCatalogItem[] = [
  ...
  { kind: "rr-armchair", name: "Ramon's oak armchair", category: "realroom", icon: "🪑", note: "Cream cushions in a curved oak frame", placement: "floor", supportHeight: 1.15 },
  { kind: "rr-radiator", name: "White wall radiator", category: "realroom", icon: "♨️", note: "Nine vertical fins beside the desk", placement: "wall", defaultY: 0 },
  { kind: "rr-lucky-bamboo", name: "Lucky bamboo in glass", category: "realroom", icon: "🎋", note: "Tall cane, clear vase and leafy crown", placement: "floor" },
  { kind: "rr-built-in-wardrobe", name: "Built-in wardrobe wall", category: "realroom", icon: "▥", note: "White upper and lower cupboards with black knobs", placement: "floor" },
  { kind: "rr-interior-door", name: "White interior door", category: "realroom", icon: "🚪", note: "Panelled door with a black lever", placement: "wall", defaultY: 0 },
  ...
  { kind: "rr-waste-bin", name: "Black lined wastebasket", category: "realroom", icon: "🗑️", note: "Small black bin with a pale blue liner", placement: "floor" },
